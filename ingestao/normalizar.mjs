...
// O saneador mudou de casa: agora é `servidor/sanear.mjs`, porque o leitor
// também manda marcação (trilho C) e os dois caminhos têm que usar o MESMO
// filtro. Aqui fica só o reexporte, para não quebrar quem já importava daqui.
