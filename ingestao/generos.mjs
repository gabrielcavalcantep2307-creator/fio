...
const GENEROS = [
  {
    ...
    livros: [
      ...
      { titulo: 'O Senhor da Guerra de Marte', autor: 'Edgar Rice Burroughs', morte: 1950, gutenberg: 68, de: 'en', chamada: 'A terceira aventura marciana: John Carter atravessa o polo gelado para resgatar quem ama.' },
      { titulo: 'Os Primeiros Homens na Lua', autor: 'H. G. Wells', morte: 1946, gutenberg: 1013, de: 'en', chamada: 'Dois ingleses chegam à Lua e encontram, sob a superfície, uma civilização inteira de insetos.' },
      { titulo: 'A Ilha do Doutor Moreau', autor: 'H. G. Wells', morte: 1946, gutenberg: 159, de: 'en', chamada: 'Numa ilha, um cientista transforma animais em quase-homens à faca. O horror é quando começam a regredir.' },
      { titulo: 'Da Terra à Lua', autor: 'Júlio Verne', morte: 1905, gutenberg: 83, de: 'en', chamada: 'Um clube de artilheiros resolve disparar um projétil tripulado à Lua. Verne calculou tudo — e errou por pouco.' },
      { titulo: 'A Ilha Misteriosa', autor: 'Júlio Verne', morte: 1905, gutenberg: 1268, de: 'en', chamada: 'Cinco náufragos reconstroem a civilização numa ilha deserta, vigiados por um benfeitor invisível.' },
      { titulo: 'O Mundo Perdido', autor: 'Arthur Conan Doyle', morte: 1930, gutenberg: 139, de: 'en', chamada: 'Uma expedição acha um planalto na Amazônia onde os dinossauros nunca foram extintos.' },
      { titulo: 'Planolândia', autor: 'Edwin A. Abbott', morte: 1926, gutenberg: 201, de: 'en', chamada: 'Um quadrado que vive num mundo de duas dimensões tenta imaginar a terceira. Matemática virada em fábula.' },
      { titulo: 'Daqui a Cem Anos', autor: 'Edward Bellamy', morte: 1898, gutenberg: 624, de: 'en', chamada: 'Um homem adormece em 1887 e acorda no ano 2000, numa sociedade sem dinheiro nem pobreza.' },
      { titulo: 'A Raça que Há de Vir', autor: 'Edward Bulwer-Lytton', morte: 1873, gutenberg: 1951, de: 'en', chamada: 'Um mundo subterrâneo movido por uma energia chamada Vril, e uma raça que a domina.' },
    ],
  },
  {
    ...
    livros: [
      ...
      { titulo: 'O Castelo de Otranto', autor: 'Horace Walpole', morte: 1797, gutenberg: 696, de: 'en', chamada: 'O primeiro romance gótico, de 1764: um castelo, uma profecia, e um elmo gigante que cai do céu.' },
      { titulo: 'A Volta do Parafuso', autor: 'Henry James', morte: 1916, gutenberg: 209, de: 'en', chamada: 'Uma governanta jura que os fantasmas rondam as duas crianças. O terror é não saber se ela tem razão.' },
      { titulo: 'Carmilla', autor: 'Joseph Sheridan Le Fanu', morte: 1873, gutenberg: 10007, de: 'en', chamada: 'A vampira que veio antes de Drácula, e a história de amor e horror entre duas jovens.' },
      { titulo: 'O Grande Deus Pã', autor: 'Arthur Machen', morte: 1947, gutenberg: 389, de: 'en', chamada: 'Um experimento abre uma janela para o outro lado, e o que entra não deveria existir. Lovecraft o chamou de obra-prima.' },
      { titulo: 'O Fantasma da Ópera', autor: 'Gaston Leroux', morte: 1927, gutenberg: 175, de: 'en', chamada: 'Sob a Ópera de Paris mora um gênio desfigurado que ama uma cantora. Romance, mistério e tragédia.' },
      { titulo: 'A Lenda do Cavaleiro Sem Cabeça', autor: 'Washington Irving', morte: 1859, gutenberg: 41, de: 'en', chamada: 'Sleepy Hollow: um professor medroso, uma aposta amorosa, e um cavaleiro decapitado na noite.' },
    ],
  },
  {
    ...
    livros: [
      ...
      { titulo: 'A Terra Maravilhosa de Oz', autor: 'L. Frank Baum', morte: 1919, gutenberg: 54, de: 'en', chamada: 'A volta a Oz, agora sem Dorothy: um menino, um espantalho rei, e uma revolução.' },
      { titulo: 'Phantastes', autor: 'George MacDonald', morte: 1905, gutenberg: 325, de: 'en', chamada: 'O livro que Tolkien e C. S. Lewis apontaram como a origem da fantasia moderna: uma jornada por um país de fadas para adultos.' },
      { titulo: 'A Princesa e o Goblin', autor: 'George MacDonald', morte: 1905, gutenberg: 708, de: 'en', chamada: 'Uma princesa, um menino mineiro, e um reino de goblins debaixo da montanha.' },
      { titulo: 'A Floresta do Fim do Mundo', autor: 'William Morris', morte: 1896, gutenberg: 3055, de: 'en', chamada: 'Antes de Tolkien, Morris inventou o mundo secundário: um herói atravessa terras encantadas que nunca existiram.' },
      { titulo: 'Cinco Crianças e Um Ser', autor: 'Edith Nesbit', morte: 1924, gutenberg: 778, de: 'en', chamada: 'Cinco irmãos desenterram uma fada rabugenta que concede um desejo por dia — e cada desejo dá errado.' },
    ],
  },
  {
    ...
    livros: [
      ...
      { titulo: 'Vinte Anos Depois', autor: 'Alexandre Dumas', morte: 1870, gutenberg: 1259, de: 'en', chamada: 'A volta dos mosqueteiros, mais velhos e em lados opostos de uma guerra civil.' },
      { titulo: 'O Homem da Máscara de Ferro', autor: 'Alexandre Dumas', morte: 1870, gutenberg: 2759, de: 'en', chamada: 'O fim da saga dos mosqueteiros, e o segredo do prisioneiro cujo rosto ninguém pode ver.' },
      { titulo: 'Ivanhoé', autor: 'Walter Scott', morte: 1832, gutenberg: 82, de: 'en', chamada: 'Cavaleiros, torneios e a Inglaterra saxã sob o jugo normando. O romance que inventou a Idade Média que imaginamos.' },
      { titulo: 'O Prisioneiro de Zenda', autor: 'Anthony Hope', morte: 1933, gutenberg: 95, de: 'en', chamada: 'Um inglês em férias é obrigado a se passar pelo rei de um reino imaginário. A aventura de trono trocado que virou molde.' },
      { titulo: 'A Pimpinela Escarlate', autor: 'Emma Orczy', morte: 1947, gutenberg: 60, de: 'en', chamada: 'Na Revolução Francesa, um herói mascarado arranca aristocratas da guilhotina. O primeiro herói de identidade secreta.' },
      { titulo: 'As Minas do Rei Salomão', autor: 'H. Rider Haggard', morte: 1925, gutenberg: 2166, de: 'en', chamada: 'A caça ao tesouro na África que inventou o gênero: o mapa, o deserto, e a câmara de diamantes.' },
      { titulo: 'Ela', autor: 'H. Rider Haggard', morte: 1925, gutenberg: 3155, de: 'en', chamada: 'No coração da África, uma rainha imortal espera há dois mil anos o retorno de um amor.' },
      { titulo: 'As Aventuras de Robin Hood', autor: 'Howard Pyle', morte: 1911, gutenberg: 964, de: 'en', chamada: 'Robin Hood, Frei Tuck e os foras-da-lei de Sherwood, na versão que fixou a lenda.' },
      { titulo: 'Presa Branca', autor: 'Jack London', morte: 1916, gutenberg: 910, de: 'en', chamada: 'O inverso de O Chamado Selvagem: um lobo selvagem que aprende, aos poucos, a confiar no homem.' },
      { titulo: 'O Capitão Blood', autor: 'Rafael Sabatini', morte: 1950, gutenberg: 1965, de: 'en', chamada: 'Um médico injustamente escravizado vira o pirata mais temido do Caribe. Capa e espada no mar.' },
      { titulo: 'Beowulf', autor: 'Anônimo (épico anglo-saxão)', morte: 1000, gutenberg: 16328, de: 'en', chamada: 'O poema épico mais antigo em inglês: um herói, três monstros, e a coragem diante do próprio fim.' },
      { titulo: 'O Cantar de Rolando', autor: 'Anônimo (cantar de gesta)', morte: 1200, gutenberg: 391, de: 'en', chamada: 'O cantar de gesta medieval: a última batalha de Rolando, sobrinho de Carlos Magno, em Roncesvales.' },
    ],
  },
]
